...
BTI_TYPE_MAPPING = {
    # SHFC 계열
    "SHFCH": {"name": "꿀단지에 빠진 인절미 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["꿀 막걸리", "밤 막걸리", "탄산 생막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SHFCL": {"name": "꿀단지에 빠진 인절미 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["꿀 막걸리", "밤 막걸리", "탄산 생막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SHFU 계열
    "SHFUH": {"name": "탄산 톡톡 딸기 요거트 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["딸기 탄산막걸리", "복숭아 생막걸리", "유자 탁주"], "alcohol_label": "고도수(9도 이상)"},
    "SHFUL": {"name": "탄산 톡톡 딸기 요거트 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["딸기 탄산막걸리", "복숭아 생막걸리", "유자 탁주"], "alcohol_label": "저도수(8도 이하)"},
    # SHMC 계열
    "SHMCH": {"name": "쫀득쫀득 꿀 찹쌀떡 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["찹쌀탁주", "원주 막걸리", "고구마 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SHMCL": {"name": "쫀득쫀득 꿀 찹쌀떡 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["찹쌀탁주", "원주 막걸리", "고구마 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SHMU 계열
    "SHMUH": {"name": "포근포근 꽃복숭아 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["망고 막걸리", "블루베리 탁주", "샤인머스캣 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SHMUL": {"name": "포근포근 꽃복숭아 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["망고 막걸리", "블루베리 탁주", "샤인머스캣 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SLFC 계열
    "SLFCH": {"name": "청량함 가득 사과 푸딩 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["저도수 생막걸리", "쌀 막걸리", "캔 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SLFCL": {"name": "청량함 가득 사과 푸딩 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["저도수 생막걸리", "쌀 막걸리", "캔 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SLFU 계열
    "SLFUH": {"name": "팝핑 과일 에이드 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["자몽 막걸리", "레몬 탁주", "오미자 탄산막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SLFUL": {"name": "팝핑 과일 에이드 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["자몽 막걸리", "레몬 탁주", "오미자 탄산막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SLMC 계열
    "SLMCH": {"name": "햇살 머금은 식혜 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["맑은 탁주", "단술", "저도수 쌀막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SLMCL": {"name": "햇살 머금은 식혜 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["맑은 탁주", "단술", "저도수 쌀막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # SLMU 계열
    "SLMUH": {"name": "산들바람 머금은 화전 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["꽃잎 막걸리", "허브 탁주", "사과 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "SLMUL": {"name": "산들바람 머금은 화전 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["꽃잎 막걸리", "허브 탁주", "사과 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DHFC 계열
    "DHFCH": {"name": "바삭하게 터지는 현미 누룽지 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["고도수 생막걸리", "드라이한 탁주", "호밀 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DHFCL": {"name": "바삭하게 터지는 현미 누룽지 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["고도수 생막걸리", "드라이한 탁주", "호밀 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DHFU 계열
    "DHFUH": {"name": "반전매력 고추냉이 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["오미자 탄산막걸리", "생강 탁주", "쑥 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DHFUL": {"name": "반전매력 고추냉이 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["오미자 탄산막걸리", "생강 탁주", "쑥 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DHMC 계열
    "DHMCH": {"name": "묵묵한 바위 속 숭늉 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["무감미료 탁주", "고도수 원주", "옥수수 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DHMCL": {"name": "묵묵한 바위 속 숭늉 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["무감미료 탁주", "고도수 원주", "옥수수 막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DHMU 계열
    "DHMUH": {"name": "안개 낀 숲속의 황금사과 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["산미 특화 막걸리", "약재 향 탁주", "드라이 과일막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DHMUL": {"name": "안개 낀 숲속의 황금사과 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["산미 특화 막걸리", "약재 향 탁주", "드라이 과일막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DLFC 계열
    "DLFCH": {"name": "청량한 대나무 숲의 차 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["가벼운 드라이 막걸리", "탄산 약주", "쌀 생막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DLFCL": {"name": "청량한 대나무 숲의 차 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["가벼운 드라이 막걸리", "탄산 약주", "쌀 생막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DLFU 계열
    "DLFUH": {"name": "차가운 도시의 샹그리아 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["드라이 유자막걸리", "진저 탁주", "탄산 베리막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DLFUL": {"name": "차가운 도시의 샹그리아 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["드라이 유자막걸리", "진저 탁주", "탄산 베리막걸리"], "alcohol_label": "저도수(8도 이하)"},
    # DLMC 계열
    "DLMCH": {"name": "대숲에 앉은 맑은 백설기 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["정통 드라이 탁주", "맑은 막걸리", "가벼운 누룩주"], "alcohol_label": "고도수(9도 이상)"},
    "DLMCL": {"name": "대숲에 앉은 맑은 백설기 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["정통 드라이 탁주", "맑은 막걸리", "가벼운 누룩주"], "alcohol_label": "저도수(8도 이하)"},
    # DLMU 계열
    "DLMUH": {"name": "빗소리 들리는 다실의 꽃차 (고도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["산미 있는 가벼운 탁주", "허브 드라이막걸리", "차 콜라보 막걸리"], "alcohol_label": "고도수(9도 이상)"},
    "DLMUL": {"name": "빗소리 들리는 다실의 꽃차 (저도수)", "tags": ["#부드러운단맛", "#화사한과일향"], "drinks": ["산미 있는 가벼운 탁주", "허브 드라이막걸리", "차 콜라보 막걸리"], "alcohol_label": "저도수(8도 이하)"},
}
...
class SurveyToVectorConverter:
    ...
    def determine_bti_code_knn(self, taste_vector: dict) -> str:
        ...
        return self.knn_encoder.inverse_transform(pred)[0]
    ...
    def convert(self, survey: SurveyResponse) -> Dict[str, float]:
        ...
        # BTI 코드 판정: KNN 우선, 없으면 Rule-based
        rule_bti_code = (
        ...
        knn_code = self.determine_bti_code_knn({
