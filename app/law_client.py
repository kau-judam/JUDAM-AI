...
**Few-shot 예시:**
- 제목 "숙취 없는 건강 막걸리" → {{"verdict":"block","category":"과대광고/허위표시","law":"식품위생법","reason":"숙취 없음·건강 효능 표방"}}
- 제목 "다이어트에 좋은 막걸리" → {{"verdict":"block","category":"과대광고/허위표시","law":"식품위생법","reason":"다이어트 효능 표방"}}
- 제목 "미성년자용 딸기 막걸리" → {{"verdict":"block","category":"미성년자 타겟","law":"청소년보호법","reason":"미성년자 대상 표현"}}
- 제목 "원금 보장 막걸리 펀딩" → {{"verdict":"block","category":"펀딩 금융 규제","law":"자본시장법","reason":"원금 보장 표현"}}
- 제목 "고수익률 막걸리 펀딩" 설명 "무위험 투자" → {{"verdict":"block","category":"펀딩 금융 규제","law":"자본시장법","reason":"무위험·고수익 약속"}}
- 제목 "정직한 약주 펀딩" 설명 "수익 보장 안 함, 원금 손실 위험 고지" → {{"verdict":"pass","category":"","law":"","reason":"위험 고지는 정상 신호, 수익 보장 없음"}}
- 제목 "전통주 제조 리워드 펀딩" 설명 "후원하면 막걸리 제공" → {{"verdict":"pass","category":"","law":"","reason":"리워드형 펀딩(제품 제공 대가)은 정상"}}
- 제목 "다음날 개운한 막걸리" → {{"verdict":"review","category":"과대광고 소지","law":"식품위생법","reason":"숙취 해소를 암시할 소지(직접 단정 아님)"}}
- 제목 "취하지 않는 순한 술" → {{"verdict":"review","category":"과대광고 소지","law":"식품위생법","reason":"취하지 않는다는 비현실적 암시 소지"}}
- 제목 "전통 방식 그대로 빚은 약주" → {{"verdict":"pass","category":"","law":"","reason":"'약주'는 정상 주종명, 효능 표방 없음"}}
- 제목 "완벽한 균형의 청주" → {{"verdict":"pass","category":"","law":"","reason":"단순 맛 표현, '청주'는 정상 주종명"}}
- 제목 "제주 감귤로 만든 막걸리" → {{"verdict":"pass","category":"","law":"","reason":"원료·산지 표현, 문제 없음"}}
